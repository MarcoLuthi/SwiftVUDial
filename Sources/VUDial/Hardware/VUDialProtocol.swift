...
public struct VUDialProtocol {
    ...
    public static func buildCommand(command: Command, dataType: DataType, payload: String = "") -> String {
    ...
    public static func setValueCommand(dialIndex: UInt8, percentage: Double) -> String {
    ...
    /// - Returns: Command string
    public static func setBacklightCommand(
        dialIndex: UInt8,
        red: Double,
        green: Double,
        blue: Double
    ...
    /// - Returns: Command string
    public static func getUIDCommand(dialIndex: UInt8) -> String {
    ...
    /// - Returns: Command string
    public static func rescanBusCommand() -> String {
    ...
    /// - Returns: Command string
    public static func displayClearCommand(dialIndex: UInt8, whiteBackground: Bool) -> String {
    ...
    ///   - y: Y coordinate
    /// - Returns: Command string
    public static func displayGotoXYCommand(dialIndex: UInt8, x: UInt16, y: UInt16) -> String {
    ...
    /// - Returns: Command string
    public static func displayImageDataCommand(dialIndex: UInt8, data: Data) -> String {
    ...
    /// - Parameter dialIndex: I2C bus index of dial
    /// - Returns: Command string
    public static func displayShowImageCommand(dialIndex: UInt8) -> String {
        let payload = toHex(dialIndex)
    ...
    public static func parseResponse(_ responseData: Data) -> ParsedResponse? {
    ...
    /// - Returns: Parsed response or nil if invalid
    public static func parseResponse(_ response: String) -> ParsedResponse? {
...
public struct ParsedResponse {
    ...
    public var payloadHexString: String {
        return payload
    }
