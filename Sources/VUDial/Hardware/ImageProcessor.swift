...
public struct ImageProcessor {
    // MARK: - Constants
    public static let displayWidth: Int = 200   // Display is 200 wide × 144 tall
    public static let displayHeight: Int = 144
    public static let threshold: UInt8 = 127  // Grayscale threshold for 1-bit conversion
    ...
    public static func convertImage(_ image: NSImage) -> Data? {
    ...
    public static func unpackImage(_ packedData: Data) -> NSImage? {
        let expectedSize = displayWidth * (displayHeight / 8)
