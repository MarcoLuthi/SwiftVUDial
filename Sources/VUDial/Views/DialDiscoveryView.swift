...
public struct DialDiscoveryView: View {
    // MARK: - Environment
    @Environment(\.modelContext) private var modelContext
    @Query(sort: \Dial.index) private var dials: [Dial]

    // MARK: - Properties
    @ObservedObject public var dialManager: DialManager
    @ObservedObject public var serialManager: SerialPortManager
    @Binding public var selectedDial: Dial?

    @State private var editingDial: Dial?
    @State private var newName: String = ""
    
    public init(dialManager: DialManager, serialManager: SerialPortManager, selectedDial: Binding<Dial?>) {
        self.dialManager = dialManager
        self.serialManager = serialManager
        self._selectedDial = selectedDial
    }
